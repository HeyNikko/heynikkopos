...
let db=load(),pendingProductImage='',editSaleDraft=[],selectedSaleIds=new Set(),sb=null,cloudSession=null,cloudSyncTimer=null,cloudProductSnapshot=new Map(),cloudEventSyncTimer=null,cloudSaleSyncTimer=null,cloudWorkspacePoller=null,cloudRealtimeChannel=null,cloudRealtimeTimer=null,cloudRealtimeInventoryTimer=null,cloudRealtimeProductTimer=null,cloudFocusRefreshBusy=false,posCategoryState=localStorage.getItem('heynikko_pos_category')||'';
