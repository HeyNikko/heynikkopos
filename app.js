...
function bundlePriceForEvent(pr,e=currentEvent()){
  ...
  if(code==='TWD'){
    ...
    if(Number.isFinite(direct)&&direct>0)return roundEventPrice(direct,e);
  }
  if(code==='SGD')return Number(pr.bundlePrice)||0;
  return eventBaseToLocal(Number(pr.bundlePrice)||0,e);
}
